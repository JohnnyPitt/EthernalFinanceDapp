...
const Home = (props) => {
  ...
  return (
    <div className="container-fluid app-container mb-4">
      <Header
        logout={logout}
      ...
      <div className="row mt-5 mt-md-2">
        ...
        <div
          className={"col-md-3 " + (view === 2 ? "active-tab" : "inactive-tab")}
        >
          <RightContent
            connectWallet={connectWallet}
            userAddress={userAddress}
        ...
        <div
          className={
            "col-md-3 mb-5 " + (view === 3 ? "active-tab" : "inactive-tab")
          }
        >
          <Governance
            connectWallet={connectWallet}
            ...
            walletType={walletType}
            balance={userData.userBalance}
            category={contractData.Getcat}
          />
        </div>
        <div
          className={
            "col-md-3 mb-5 " + (view === 4 ? "active-tab" : "inactive-tab")
          }
        >
          <Lotto />
        </div>
