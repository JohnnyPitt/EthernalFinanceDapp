...
const LeftContent = (props) => {
  ...
  return (
    <div className="left-content ">
      <div class="payoutinfo2">
        <div class="payoutinfoHeader">Your Rewards</div>
        <div className="claybtn2" onClick={() => setButtonPopup(true)}></div>
      ...
      <div className="text-center claybtnb">
        {userAddress ? (
          <div
